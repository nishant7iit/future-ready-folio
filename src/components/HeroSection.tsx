      ...
      <div className="section-container">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
          <div className="space-y-8 animate-fade-in">
            <div>
              <h2 className="text-lg md:text-xl text-primary font-medium mb-2">Hello, I'm</h2>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-display font-bold text-foreground leading-tight">
                Future Tech <br />
                Professional
              </h1>
              <p className="mt-6 text-lg text-muted-foreground max-w-lg">
                Pre-final year B.Tech student passionate about technology, innovation, and problem-solving.
            ...
            <div className="flex gap-6 items-center">
              <div className="h-[1px] w-10 bg-muted-foreground/30"></div>
          ...
          <div className="relative flex justify-center">
            <div className="relative w-64 h-64 md:w-80 md:h-80 rounded-full bg-gradient-to-tr from-primary to-accent animate-bounce-slow">
